        ...
        <div className="about" id="about">
            ...
            <div className="bottomBar">
                <div className="contactMethod">
                    <svg className="emailIcon" xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="#ca213e" class="bi bi-envelope-fill" viewBox="0 0 16 16">
                    ...
                    <svg className="linkedinIcon" xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="#3a7dbd" class="bi bi-linkedin" viewBox="0 0 16 16">
                    ...
                    Copyright &copy; 2022 Sam Lui. All Rights Reserved.
                </div>
